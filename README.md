...
**Ok, starting by the PlaceViewModel...** we need a method that will return all places for us. The PlaceDAO contains the getAll method, that returns a Flowable, witch is a variation of ReactiveX Observable. Ok, for now is just return ths  we start to moving the fetch logic from MainActivity to PlaceViewModel, calling the PlaceDAO.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTUzMzc0Mjc3LC0xNjAwNTY1MjYsMTA1ND
