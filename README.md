...
Continuing... following the MVVM  specifications, the ViewModel should expose streams to the view. Until now, we are't givin
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDIwOTk1MjAxLDE0NzI1ODc5NDUsLTIxMz
