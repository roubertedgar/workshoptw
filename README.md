...
This is not good, we should make the PlaceFormActivity tells the ViewModel to save the Place for us, right? 

So, l

<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE5MDgyMjI0LDEyMjI4MjczMTksMTYxOT
