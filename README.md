...
First things first, let's remove remove the the and tells the ViewModel to save our place passing the created Place:
...
On the main a
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMDY5NjU0NjksLTE2Mzk1MzY2MDQsMT
